      ...
      <div className="max-w-sm w-full text-center space-y-5">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            Um erro inesperado ocorreu no painel administrativo.
          </p>
          {error.digest && (
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            onClick={reset}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-violet-600
              text-sm font-semibold text-white hover:bg-violet-500 transition-colors"
          >
            <RefreshCw size={14} />
            Tentar novamente
          </button>
