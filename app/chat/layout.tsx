            ...
            <div className="flex items-center gap-2 ml-auto">
              {tempoSessao && (
                <div
                  ...
                  className={`hidden sm:flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-mono font-semibold transition-colors bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400`}
                >
                  <Clock size={11} />
                  {tempoSessao}
                </div>
